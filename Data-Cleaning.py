...
INPUT_PATH = "Output_New_Sample_200k.xlsx"
OUTPUT_PATH = "Output_New_Sample_200k_Clean.xlsx"
...
duplicate_ids = detect_duplicates(df)

df = apply_iqr_capping(
    df,
    NUMERIC_COLUMNS
)
